-- Master Touch OS — phase3_fix_051
-- Apply this file in the Supabase Dashboard SQL Editor.
-- Equivalent to migrations/051_phase32_final_revenue_semantics.sql
-- Do NOT re-run 049 or 050. Do NOT modify 001–050.
--
-- Fixes:
-- 1) partially_certified / already-invoiced valuations eligible for further issue up to certified remaining
-- 2) payment after PAID → CLIENT_PAYMENT_EXCEEDS_OUTSTANDING (outstanding checked before status)
